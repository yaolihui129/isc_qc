...
return array(
    ...
    'WEBSERVER'         =>  'https://xiuliguanggao.com',        //定义服务器域名
    'WX_APPID'          =>  'wx0bf002643c129ee2',               //定义微信APPID
    'WX_APPSECRET'      =>  'd5ea7673ce900a09cc06fff58a560a07',

    'XL_APPID'          =>'asdasdasdasdasdasd',
    'XL_SECRET'         =>'f4wq2wr42wq2asw3e4we345rft65tr43',
    ...
    'DEVICE_RULES'=>'
        ...
        <div>
            <ol style="list-style-position: inside;">
                ...
                <li>在<a href="http://qc.zhidaoauto.com/index.php/Device">图书&设备管理平台</a>进行公示（品牌、型号、系统版本、当前借用人、预约情况及借用的历史记录）</li>
            </ol>
        </div>
