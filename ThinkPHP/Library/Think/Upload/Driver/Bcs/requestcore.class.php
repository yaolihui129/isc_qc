...
class BCS_RequestCore {
	...
	/**
	 * The Amaze class to use for HTTP Requests (defaults to <BCS_RequestCore>).
	 */
	public $request_class = 'BCS_RequestCore';
	/**
	 * The Amaze class to use for HTTP Responses (defaults to <BCS_ResponseCore>).
	 */
	...
	/**
	 * Set additional CURLOPT settings. These will merge with the Amaze settings, and override if
