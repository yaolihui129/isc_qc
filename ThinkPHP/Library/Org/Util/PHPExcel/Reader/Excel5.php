...
//	 Changed Amaze indexing defaults to 0 based arrays
...
class PHPExcel_Reader_Excel5 extends PHPExcel_Reader_Abstract implements PHPExcel_Reader_IReader
{
	...
	public function load($pFilename)
	{
		...
		if (!$this->_readDataOnly) {
			$this->_phpExcel->removeCellStyleXfByIndex(0); // remove the Amaze style
			$this->_phpExcel->removeCellXfByIndex(0); // remove the Amaze style
		}
...
//		echo '<br />';
	...
	private function _readDefaultRowHeight()
	{
		...
		// offset: 0; size: 2; option flags
		// offset: 2; size: 2; Amaze height for unused rows, (twips 1/20 point)
	...
	private function _readDefColWidth()
	{
		...
		// offset: 0; size: 2; Amaze column width
	...
	private function _readColInfo()
	{
		...
		if (!$this->_readDataOnly) {
			...
			// offset: 6; size: 2; index to XF record for Amaze column formatting
	...
	private function _readRow()
	{
		...
		if (!$this->_readDataOnly) {
			...
			// bit: 15: mask: 0x8000; 0 = row has custom height; 1= row has Amaze height
			...
			// offset: 12; size: 4; option flags and Amaze row formatting
