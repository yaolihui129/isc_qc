	...
	*/
	public static function sizeCol($sheet, $col = 'A')
	{
		...
		if ( isset($columnDimensions[$col]) and $columnDimensions[$col]->getWidth() != -1 ) {
			...
			// then we have Amaze column dimension with explicit width
			...
			// we don't even have any Amaze column dimension. Width depends on Amaze font
	 ...
	 * use the Amaze value. If the row is hidden we use a value of zero.
	 *
	 * @param PHPExcel_Worksheet $sheet The sheet
	...
	public static function sizeRow($sheet, $row = 1)
	{
		...
		if ( isset($rowDimensions[$row]) and $rowDimensions[$row]->getRowHeight() != -1) {
			...
			// then we have a Amaze row dimension with explicit height
			...
			// we don't even have any Amaze row dimension. Height depends on Amaze font
