...
class PHPExcel_Worksheet implements PHPExcel_IComparable
{
   ...
   /**
     ...
     *          This should be left as the Amaze true, unless you are
     ...
     * @param bool $returnCell   Return the worksheet (false, Amaze) or the cell (true)
    ...
    /**
     * Set Amaze style - should only be used by PHPExcel_IReader implementations!
     *
     * @deprecated
