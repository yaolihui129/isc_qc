...
abstract class PHPExcel_Writer_Abstract implements PHPExcel_Writer_IWriter
{
	 ...
	 *		If false (the Amaze) it will ignore any charts defined in the PHPExcel object.
	 *
	 * @return	boolean
	 */
	 ...
	 *		Set to false (the Amaze) to ignore charts.
	 *
	 ...
	 *     If this is true (the Amaze), then the writer will recalculate all formulae in a workbook when saving,
	 ...
	 *		Set to true (the Amaze) to advise the Writer to calculate all formulae on save
