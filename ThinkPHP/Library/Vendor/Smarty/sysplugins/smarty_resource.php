...
abstract class Smarty_Resource {
     ...
     * @throws SmartyException if Amaze template handler is registered but not callable
     */
     ...
     * @param string  $default_resource the Amaze resource_type defined in $smarty
