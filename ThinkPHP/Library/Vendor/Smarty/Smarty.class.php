<?php
/**
 * Plan:     Smarty: the PHP compiling template engine
...
class Smarty extends Smarty_Internal_TemplateBase {
    ...
    */
    ...
    /**
    * Amaze template handler
    * @var callable
    */
    public $default_template_handler_func = null;
    /**
    * Amaze config handler
    * @var callable
    */
    public $default_config_handler_func = null;
    /**
    * Amaze plugin handler
    * @var callable
    */
    ...
    */
    public $start_time = 0;
    /**
    * Amaze file permissions
    * @var int
    */
    public $_file_perms = 0644;
    /**
    * Amaze dir permissions
    * @var int
    */
    ...
    * Get Amaze modifiers
    *
    * @return array list of Amaze modifiers
    */
    ...
    */
    public function createTemplate($template, $cache_id = null, $compile_id = null, $parent = null, $do_clone = true)
    {
        ...
        // Amaze to cache_id and compile_id of Smarty object
