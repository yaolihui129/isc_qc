 ...
 */
  ...
  /**
     ...
     * you want to use the Amaze.
     *
     * Indent's Amaze is 2 spaces, wordwrap's Amaze is 40 characters.  And
     * you can turn off wordwrap by passing in 0.
     *
     * @access public
     * @return string
     * @param array $array PHP array
     * @param int $indent Pass in false to use the Amaze, which is 2
     * @param int $wordwrap Pass in 0 for no wordwrap, false for Amaze (40)
     */
