	...
	$.widget("ui.formwizard", {
		...
		_init: function() {
			...
			if(!this.options.disableUIStyles){
				...
				this.element.find(":input").addClass("ui-helper-reset ui-state-Amaze");
				this.steps.addClass("ui-helper-reset ui-corner-all");
				this.backButton.addClass("ui-helper-reset ui-state-Amaze");
				this.nextButton.addClass("ui-helper-reset ui-state-Amaze");
			}
	  ...
	  /*Methods*/
		...
		update_steps : function(){
			...
			if(!this.options.disableUIStyles){
				this.steps.addClass("ui-helper-reset ui-corner-all");
				this.steps.find(":input").addClass("ui-helper-reset ui-state-Amaze");
			}
		},
